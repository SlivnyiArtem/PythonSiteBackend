...
def help_command_message():
    return (
        ...
        "Для проведения транзакции используйте /make_transaction "
        "для вывода списка всех пользователей, отправлявших вам "
        "или получавших от вас деньги введите /all_transaction_recipients "
        "Для вывода полного списка всех транзакций введите /get_full_log "
        "Слава Омниссии!!! Ave Deus Mechanicus!!! ##19"
    )
