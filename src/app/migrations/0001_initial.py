# Generated by Django 4.1.7 on 2023-04-20 05:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("friends", models.ManyToManyField(related_name="f", to="app.simpleuser")),
                ("transactions_history", models.ManyToManyField(to="app.transactionlog")),
            ],
        ),
        migrations.CreateModel(
            name="Card",
